              ...
              <div class="space-y-6">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-gray-600">
                      <a href="tel:+221123456789" class="hover:text-blue-600">+221 12 345 67 89</a>
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <p class="text-gray-600">
                      <a href="mailto:contact@workion.app" class="hover:text-blue-600">contact@workion.app</a>
                    </p>
                  </div>
                </div>
...
const faqs = ref([
  ...
  },
  {
    ...
    answer: 'Vous pouvez signaler un problème directement dans l\'application via la section "Support" ou nous contacter par email à support@workion.app avec les détails de votre réclamation.'
  },
  {
